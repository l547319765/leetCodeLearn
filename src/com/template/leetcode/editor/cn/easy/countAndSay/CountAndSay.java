...
package com.template.leetcode.editor.cn.easy.countAndSay;
        ...
        private String count(String n) {
            ...
            for (int i = 1; i < chars.length; i++) {
                if (chars[i] == chars[i - 1]) {
                    ...
                    stringBuilder.append(num).append(chars[i - 1]);
                    num = 1;
                }
            }
            return stringBuilder.append(num).append(chars[chars.length - 1]).toString();
        }
    }
